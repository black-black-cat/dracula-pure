...
const uiColors = {
	...
	'scrollbarSlider.activeBackground': fade(colors.yellow, 0.4),
	...
	"activityBar.activeBackground": fade(colors.blueDark, 0.3),
	...
	"tab.hoverBackground": fade(colors.blueDark, 0.2),
	// -- Active
